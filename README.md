...
|--------------------------------------------------------------------------------------|--------------------------------|-----------------------|
| 2.4.0                                                                                | 2.3.16 (or newer)              | <ul><li>Capability to specify default value for column chooser and custom chooser. This would allow any existing workflow to continue to use without any breaking change while introducing new properties during a minor upgrade.</li></ul>
