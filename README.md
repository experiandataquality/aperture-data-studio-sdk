...
|--------------------------------------------------------------------------------------|--------------------------------|-----------------------|
| 2.3.0                                                                                | 2.1.0 (or newer)               | <ul><li>Capability to rename input label node.</li><li>Returning column details by tag during configuration and processing.</li><li>Storing tags into column details.</li><li>Supporting display name and value as chooser item in Custom Chooser property.</li><li>Fixed SDK Test framework bug for failing to retrieve value from `getStepCell`.</li></ul>
